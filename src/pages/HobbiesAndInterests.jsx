...
const HobbiesAndInterests = ({ mode, setMode }) => {
  ...
  const reqData = allData.filter(pic => pic.category === 'Hobbies & Interests');
  ...
  return (
    <div className={`min-h-screen pt-16 ${mode ? "bg-blue-300 text-gray-700" : "bg-slate-900 text-gray-400"}`}>
      ...
      <div className="mt-5 px-4">
        <h2 className="text-xl font-semibold mb-3">Hobbies And Interests</h2>
        {allLoading ? (
